...
export const constantRoutes: AppRouteRecordRaw[] = [
	...
	// 	name: 'dashboard',
	// 	meta: { title: 'dashboard', icon: 'icon-homepage', affix: false, parentName: 'mainLayout' }
	// },
	{
		path: '/algorithm',
		component: () => import('@/views/algorithm/index.vue'),
		name: 'algorithm',
		meta: { title: 'algorithm',  icon: 'icon-algoritm',parentName: 'mainLayout' } // 塞入 Layout route
	},
	{
		path: '/data',
		component: () => import('@/views/data/index.vue'),
		name: 'data',
		meta: { title: 'data',  icon: 'icon-video',parentName: 'mainLayout' } // 塞入 Layout route
	},
	// 用户中心
	{
		path: '/personal',
...
export function resetRouter() {
	...
	permission.showMenuListFlat.forEach((route:any)=> {
